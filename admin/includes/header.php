    ...
    <style>
        ...
        @media (max-width: 850px) {
            ...
            #sidebarCollapse {
                ...
                border: none;
                border-radius: 50%;
                z-index: 101; /* Ensure toggle button is above sidebar */
            }
            footer {
                width:350px;
            }
...
<div class="wrapper">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="add_journal.php"><i class="fas fa-plus"></i> <span>Add Journal</span></a>
            </li>
            <li>
                <a href="upload_journal.php"><i class="fas fa-upload"></i> <span>Upload Journal</span></a>
            </li>
            <li>
